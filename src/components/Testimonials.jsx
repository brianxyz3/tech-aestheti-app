        ...
        <section className="bg-gradient-to-b from-white to-indigo-300 text-gray-900 px-6 pt-20 pb-16">
            <div className="bg-indigo-300 rounded-bl-3xl rounded-br-2xl rounded-t-lg px-1">
                <div className="relative bottom-3 flex justify-center items-center bg-testimonialImg bg-cover bg-center h-72 rounded-bl-3xl rounded-br-2xl rounded-t-2xl">
                    <div className="inline bg-indigo-200 text-center py-3 px-4 rounded-3xl">
                        ...
                        <button className="bg-indigo-800 text-white text-xs p-2 mt-1 rounded-md hover:font-bold hover:p-3 hover:rounded-lg">REACH OUT</button>
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between">
                <div className="w-2/5">
                    ...
                    <p className="mb-2">Our designers and developers work together to create innovative and user-friendly solutions we focus on seamless functionality and design to elevate your brand's presence.</p>
                    <a href="mailto:brianchima22@gmail.com" className="bg-indigo-800 text-white px-10 py-1 hover:px-11 hover:py-2 hover:rounded-lg">Email Us</a>
                </div>
