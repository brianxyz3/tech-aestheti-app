...
const Hero = () => {
    return (
        <section className="flex flex-wrap lg:flex-nowrap gap-5 w-5/6 ps-8 mt-28">
            <div className="flex flex-col w-3/4">
                <h1 className="text-6xl font-bold mb-5">Transform Your <span className="text-gray-900 break-before-avoid">Digital</span> Presence with Our <span className="text-gray-900">Expert</span> Solution</h1>
            ...
            <div className="relative">
                <img src="../src/assets/images/hero-img.jfif" className="w-96 h-[30rem] border-2 border-indigo-200 border-b-0 rounded-t-full" alt="" />
