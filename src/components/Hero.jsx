    ...
    return (
        <section className="flex flex-wrap lg:flex-nowrap justify-center gap-5 md:w-5/6 mt-12">
            <div className="flex flex-col md:w-3/4 px-4">
                <h1 className="text-3xl md:text-5xl font-bold mb-5">Transform Your <span className="text-gray-900 break-before-avoid text_shadow_white">Digital</span> Presence with Our <span className="text-gray-900 text_shadow_white">Expert</span> Solution</h1>
